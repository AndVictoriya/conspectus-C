...
!!!	func (&MAS);//Ошибка.
	...
	scanf("%d" , MAS[0]);//запишет введенное значение по адресу равному значению ячейки MAS[0]; Это как scanf("%d", x) вместо scanf("%d", &x); но с массивом указателей это не работает...
